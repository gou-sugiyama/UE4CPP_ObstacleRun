#undef SUGIYAMAG_OBSTACLERU_API
...
#define UE_PROJECT_NAME SugiyamaG_ObstacleRu
#define UE_TARGET_NAME SugiyamaG_ObstacleRuEditor
...
#define SUGIYAMAG_OBSTACLERU_API DLLEXPORT
